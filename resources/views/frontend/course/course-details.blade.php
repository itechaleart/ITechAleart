...
<div class="bg-page">
    ...
    <section class="course-single-details-area before-login-purchase-course-details mt-5">
        <div class="container">
            <div class="row align-items-start">
                <div class="col-12 col-md-12 col-lg-8">

                    <div class="course-single-details-left-content bg-white p-4">

                        <!-- Tab panel nav list -->
                        <div class="course-tab-nav-wrap course-details-tab-nav-wrap d-flex justify-content-between mb-4">
                            <ul class="nav nav-tabs tab-nav-list border-0 bg-light rounded p-2" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active fw-semibold" id="Overview-tab" data-bs-toggle="tab" href="#Overview" role="tab" aria-controls="Overview" aria-selected="true">{{ __('Overview') }}</a>
                                </li>
                                @if($course->course_type == COURSE_TYPE_GENERAL)
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link fw-semibold" id="Curriculum-tab" data-bs-toggle="tab" href="#Curriculum" role="tab" aria-controls="Curriculum" aria-selected="false">{{ __('Curriculum') }}</a>
                                </li>
                                @endif
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link fw-semibold" id="Discussion-tab" data-bs-toggle="tab" href="#Discussion" role="tab" aria-controls="Discussion" aria-selected="false">{{ __('Discussion') }}</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link fw-semibold" id="Review-tab" data-bs-toggle="tab" href="#Review" role="tab" aria-controls="Review" aria-selected="false">{{ __('Review') }}</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link fw-semibold" id="Instructor-tab" data-bs-toggle="tab" href="#Instructor" role="tab" aria-controls="Review" aria-selected="false">{{ (count($course->course_instructors->where('status', STATUS_APPROVED)) > 1) ? __('Instructors') : __('Instructor') }}</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Tab panel nav list -->
            ...
            <div class="col-12 col-md-12 col-lg-4">
                <div class="course-single-details-right-content">
                    <div class="course-info-box bg-white" style="position:sticky; top:110px;">
                        ...
                        <div class="alert alert-success d-flex mb-15">
                            <div class="align-items-center d-flex mr-15">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-credit-card">
                        ...
                        <a href="{{ route('student.course-gift', $course->uuid) }}" class="alert alert-warning align-items-center border border-dark d-flex mb-30 p-2">
                            <div class="mr-15">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-gift text-gray">
