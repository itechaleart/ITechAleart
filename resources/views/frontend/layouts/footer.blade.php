                            ...
                            <ul class="d-flex align-items-center">
                                ...
                                <li>
                                    <a href="{{ get_option('f6s_url') }}">
                                        <img src="{{ asset('frontend/assets/img/icons/f6s.svg') }}" alt="F6s" style="width:1em;height:1em;" />
                                    </a>
                                </li>
                                @endif
                                ...
                                <li>
                                    <a href="{{ get_option('crunchbase_url') }}">
                                        <img src="{{ asset('frontend/assets/img/icons/crunchbase.svg') }}" alt="Crunchbase" style="width:1em;height:1em;" />
                                    </a>
                                </li>
                                @endif
                            </ul>
