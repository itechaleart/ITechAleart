<div class="card course-item hm-course-item {{ $course->status != STATUS_UPCOMING_APPROVED ? "" : "course-item-upcoming hm-course-item-upcoming" }} border-0 radius-3 bg-white">
    <div class="course-img-wrap hm-course-img-wrap overflow-hidden">
        ...
        <div class="course-item-hover-btns hm-course-item-hover-btns position-absolute">
            <span class="course-item-btn hm-course-item-btn addToWishlist" data-course_id="{{ $course->id }}" data-route="{{ route('student.addToWishlist') }}"
                title="Add to Wishlist">
                <i data-feather="heart"></i>
            </span>
            @if($course->status != STATUS_UPCOMING_APPROVED)
            <span class="course-item-btn hm-course-item-btn addToCart" data-course_id="{{ $course->id }}" data-route="{{ route('student.addToCart') }}"
                title="Add to Cart">
    ...
    <div class="card-body">
        <h5 class="card-title course-title hm-course-title"><a href="{{ route('course-details', $course->slug) }}">{{ Str::limit($course->title, 40)}}</a></h5>
        <p class="card-text instructor-name-certificate hm-instructor-name-certificate font-medium font-12">
        ...
        <div class="course-item-bottom">
            <div
                class="course-rating hm-course-rating search-instructor-rating w-100 mb-15 d-inline-flex align-items-center">
                <span class="font-medium font-14 me-2">{{ $course->average_rating }}</span>
                <div class="star-ratings hm-star-ratings" style="width: 83.3125px;">
