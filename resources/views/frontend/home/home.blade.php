        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                    ...
                    <a href="{{ route('lms_product.frontend.list') }}" class="theme-btn theme-button2 theme-button3">{{ __('View All') }} <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                    ...
                    <a href="{{ route('bundles') }}" class="theme-btn theme-button2 theme-button3">{{ __('View All') }} <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right">
                            <line x1="5" y1="12" x2="19" y2="12"></line>
                            <polyline points="12 5 19 12 12 19"></polyline>
                        </svg></a>
                </div>
...
<section class="top-instructor-area section-t-space gradient-bg p-0">
    <div class="section-overlay section-t-space section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                        <div class="section-title section-title-left d-flex align-items-start">
                            ...
                            <div>
                                <h3 class="section-heading section-heading-light">{{ __(get_option('top_instructor_title')) }}</h3>
                                <p class="section-sub-heading section-sub-heading-light">{{ __(get_option('top_instructor_subtitle')) }}</p>
                            </div>
                        </div>
...
<!-- Home-only modern styles (scoped, conflict-free) -->
