...
<div class="instructor-profile-right-part">
    <form method="POST" action="{{route('organization.save.profile', [$organization->uuid])}}" enctype="multipart/form-data">
        @csrf
        <div class="instructor-profile-info-box">
            ...
            <div class="profile-top mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <div class="author-info">
                        ...
                        <p class="font-14">{{ __('Accepted Image Files') }}: JPEG, JPG, PNG, WEBP <br> {{ __('Accepted Size') }}: 300 x 300 (1MB)</p>
                    </div>
                </div>
                @if ($errors->has('image'))
            ...
            <div class="row">
                <div class="col-md-6 mb-30">
                    ...
                    <input type="text" name="first_name" value="{{$organization->first_name}}" class="form-control" placeholder="{{__('First Name')}}">
                ...
                <div class="col-md-6 mb-30">
                    ...
                    <input type="text" name="last_name" value="{{$organization->last_name}}" class="form-control" placeholder="{{__('Last Name')}}">
            ...
            <div class="row">
                <div class="col-md-12 mb-30">
                    ...
                    <input type="text" name="professional_title" value="{{$organization->professional_title}}" class="form-control" placeholder="{{ __('Type your professional title') }}">
            ...
            <div class="row">
                <div class="col-md-12 mb-30">
                    ...
                    <input type="text" name="phone_number" value="{{$organization->phone_number}}" class="form-control" placeholder="{{ __('Type your phone number') }}">
            ...
            <div class="row">
                <div class="col-md-12 mb-30">
                    ...
                    <textarea class="form-control" name="about_me" id="exampleFormControlTextarea1" rows="3" placeholder="{{__('Type about yourself')}}">{{$organization->about_me}}</textarea>
            ...
            <div class="col-md-12 mb-30">
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="Male" {{$organization->gender == 'Male' ? 'checked' : '' }}>
                        <label class="form-check-label" for="inlineRadio1">{{ __('Male') }}</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="Female" {{$organization->gender == 'Female' ? 'checked' : '' }}>
                        <label class="form-check-label" for="inlineRadio2">{{ __('Female') }}</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="gender" id="inlineRadio3" value="Others" {{$organization->gender == 'Others' ? 'checked' : '' }}>
