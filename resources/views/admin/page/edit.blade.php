        ...
        <div class="row">
            <div class="col-md-12">
                <div class="customers__area bg-style mb-30">
                    ...
                    <form action="{{route('page.update', $page->uuid)}}" enctype="multipart/form-data" method="post" class="form-horizontal">
                        @csrf
                        ...
                        <div class="input__group mb-25">
                            ...
                            <input type="text" name="meta_title" value="{{ old('meta_title', $page->meta_title) }}" placeholder="{{ __('Meta title') }}" class="form-control">
                        ...
                        <div class="input__group mb-25">
                            ...
                            <input type="text" name="meta_description" value="{{ old('meta_description', $page->meta_description) }}" placeholder="{{ __('meta description') }}" class="form-control">
                        ...
                        <div class="input__group mb-25">
                            ...
                            <input type="text" name="meta_keywords" value="{{ old('meta_keywords',  $page->meta_keywords) }}" placeholder="{{ __('meta keywords') }}" class="form-control">
                        ...
                        <div class="input__group mb-25">
                            ...
                            <div class="upload-img-box">
                                ...
                                <img src="{{getImageFile($page->og_image)}}">
                                @else
                                <img src="">
                                @endif
