            ...
            <div class="col-lg-9 col-md-8">
                <div class="email-inbox__area bg-style form-horizontal__item bg-style admin-general-settings-page">
                    ...
                    <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="row input__group mb-25">
                            <label class="col-lg-3">{{ __('F6s URL') }} <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" name="f6s_url" value="{{get_option('f6s_url')}}" class="form-control">
                            </div>
                        </div>

                        <div class="row input__group mb-25">
                            <label class="col-lg-3">{{ __('Crunchbase URL') }} <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <input type="text" name="crunchbase_url" value="{{get_option('crunchbase_url')}}" class="form-control">
                            </div>
                        </div>
