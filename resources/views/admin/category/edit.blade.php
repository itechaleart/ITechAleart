                ...
                <div class="form-vertical__item bg-style">
                    ...
                    <form action="{{route('category.update', [$category->uuid])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input__group mb-25">
                            ...
                            <input type="text" name="meta_title" value="{{ old('meta_title', $category->meta_title) }}" placeholder="{{ __('Meta title') }}" class="form-control">
                        ...
                        <div class="input__group mb-25">
                            ...
                            <input type="text" name="meta_description" value="{{ old('meta_description', $category->meta_description) }}" placeholder="{{ __('meta description') }}" class="form-control">
                        ...
                        <div class="input__group mb-25">
                            ...
                            <input type="text" name="meta_keywords" value="{{ old('meta_keywords',  $category->meta_keywords) }}" placeholder="{{ __('meta keywords') }}" class="form-control">
