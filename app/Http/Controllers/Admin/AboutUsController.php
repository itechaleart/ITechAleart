...
class AboutUsController extends Controller
{
    ...
    public function galleryAreaUpdate(Request $request)
    {
        $request->validate([
            ...
            'gallery_first_image' => 'mimes:jpg,webp|file',
            'gallery_second_image' => 'mimes:jpg,webp|file',
            'gallery_third_image' => 'mimes:jpg,webp|file'
        ]);
    ...
    {
        $request->validate([
            'upgrade_skill_logo' => 'mimes:jpg,jpeg,png,webp|file',
        ]);
        $about = AboutUsGeneral::first();
        if (!$about) {
            $about = new AboutUsGeneral();
    ...
    public function teamMemberUpdate(Request $request)
    {
        $request->validate([
            ...
            'team_member_logo' => 'mimes:png,webp|file',
        ]);
